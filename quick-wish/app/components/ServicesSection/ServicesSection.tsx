      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 gap-3 min-[420px]:grid-cols-2 md:grid-cols-4">
          ...
          <div className="text-center p-4 rounded-lg border border-[color:var(--border)] bg-[color:var(--surface)] shadow-sm">
            ...
            <h3 className="font-medium text-[color:var(--plum)] mb-1">Handmade hampers</h3>
            <p className="text-xs text-[color:var(--muted)]">Built, wrapped, and checked by hand.</p>
          </div>
          
          <div className="text-center p-4 rounded-lg border border-[color:var(--border)] bg-[color:var(--surface)] shadow-sm">
            <MessageSquareText className="h-8 w-8 text-[color:var(--gold)] mx-auto mb-2" />
            <h3 className="font-medium text-[color:var(--plum)] mb-1">Custom notes</h3>
            <p className="text-xs text-[color:var(--muted)]">Add names, wishes, and tiny details.</p>
          </div>

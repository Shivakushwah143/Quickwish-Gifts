...
// Admin sign-in only. Public admin signup was removed on the backend (admin
// creation requires the ADMIN_BOOTSTRAP_KEY), so the signup tab is gone here.
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md relative overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-pink-500 to-purple-600 p-6 text-white">
          ...
          <p className="text-center text-pink-100 text-sm">Sign in to the admin panel</p>
        </div>
